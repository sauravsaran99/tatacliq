...
function navbar() {
    ...
    <div id="ravnavtwo">
        ...
        <div id="ravnavtwotwo">
            <div class="two1">Categories</div>
            <div class="two2">Brands</div>
            <div class="two3">
                <input type="search" id="search">
            </div>
            <div class="two4">
                <svg id="svg1" xmlns="http://www.w3.org/2000/svg" width="100%" height="38%" viewBox="0 0 13 19">
